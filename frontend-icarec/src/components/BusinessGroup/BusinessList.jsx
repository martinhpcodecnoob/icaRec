  ...
  const businessArray = [
    {
      ...
      images: [
        ...
        {
          url_cloudinary:
            "http://res.cloudinary.com/dl6jys7s8/image/upload/v1694544010/MartinHernandezPe%C3%B1a/Hughenet/ioitkcstmgvbjgwbmzzy.jpg",
    ...
    },
    {
      ...
      description:
        "En nuestra pastelería, nos dedicamos a crear momentos dulces y memorables a través de una deliciosa variedad de pasteles, postres y repostería de alta calidad. Nuestros talentosos pasteleros artesanales preparan cada dulce con amor y cuidado, utilizando ingredientes frescos y de primera calidad. Ya sea que estés buscando un pastel personalizado para una ocasión especial, galletas recién horneadas para acompañar tu café o una selección de pasteles para endulzar tu día, en nuestra pastelería encontrarás una experiencia de sabor única. Ven y disfruta de un rincón de dulzura en cada bocado, donde la pasión por la repostería se fusiona con la excelencia en cada creación.",
      cellphone: "555123456",
      ...
      services: ["Café gourmet", "Pasteles caseros", "desayuno"],
      images: [
        {
          url_cloudinary:
            "http://res.cloudinary.com/dl6jys7s8/image/upload/v1694584904/JulioCastroAlejos/Caf%C3%A9%20del%20Amanecer/xswvgaw2uzpe5w91vcej.jpg",
        ...
        {
          url_cloudinary:
            "http://res.cloudinary.com/dl6jys7s8/image/upload/v1694584904/JulioCastroAlejos/Caf%C3%A9%20del%20Amanecer/gttzempp44t6j9y7h4ul.jpg",
